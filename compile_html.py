...
<head>
  ...
  <style>
    ...
    * {
    ...
    .mole-sign {
      position: absolute;
      top: -72px; /* Adjusted position for larger font */
      background: #FFFFFF;
      border: 3.5px solid var(--border-color);
      border-radius: 14px;
      padding: 8px 12px;
      font-size: 14px; /* Enlarged font for options */
      font-weight: 900;
      width: 165px; /* Extra width to look clean and neat */
      text-align: center;
      box-shadow: 4px 4px 0px var(--border-color);
      pointer-events: none;
...
<body>
  ...
  <script>
    ...
    function hideMole(index) {
      ...
      if (sign) sign.classList.remove('up');
