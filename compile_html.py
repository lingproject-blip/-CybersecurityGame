...
<body>
  ...
  <div id="app-container">
    ...
    <div class="view active" id="view-home">
      ...
      <!-- Name Input Section -->
      <div style="background: #FFFFFF; border: 4px solid var(--border-color); border-radius: 20px; padding: 12px 20px; margin: 0 0 20px 0; display: flex; align-items: center; justify-content: space-between; box-shadow: 4px 4px 0px var(--border-color); flex-shrink: 0; flex-wrap: wrap; gap: 10px;">
        ...
        <div style="font-size: 13px; font-weight: 800; color: #7A7060; display: flex; align-items: center; gap: 4px;">
  ...
  <script>
    ...
    function saveTeacherSettings() {
      const input = document.getElementById('gas-url-input');
      state.googleAppScriptUrl = input.value.trim();
      saveProgress();
